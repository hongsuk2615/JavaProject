...
public class KafkaConfig {
  ...
  // 채팅 DTO 역직렬화 설정
    ...
    public ConsumerFactory<String, ChatMessageDto> chatConsumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.springboot.springproject.kafka.dto.ChatMessageDto");
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.springboot.springproject.kafka.dto");
        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ChatMessageDto> chatListenerFactory() {
